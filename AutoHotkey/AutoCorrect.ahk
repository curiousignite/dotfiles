...
#EscapeChar \
StringReplace, path, path,Executables\\main\.exe, AutoCorrect\.ahk, All
;MsgBox, %path% debugging

FileAppend, %Hotstring%, %path% ; Put a `n at the beginning in case file lacks a blank line at its end.
Reload

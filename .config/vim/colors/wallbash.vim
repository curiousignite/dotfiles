...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  if s:is_dark
    let g:terminal_ansi_colors = ['020A1B', '9F65A3', '7A91C2', '7A8CC2',
                                \ '657AA3', '9AACE6', '9AB2E6', 'FFFFFF',
                                \ '05215A', 'BC7AC2', '9AB2E6', 'AABBF0',
                                \ '7A92C2', 'AABBF0', 'AAC0F0', 'FFFFFF']
  else
    " Lighter colors for light theme
    let g:terminal_ansi_colors = ['FFFFFF', 'E09AE6', 'AAC0F0', 'AABBF0',
                                \ '9AB3E6', 'CCD8FF', 'CCDCFF', '425694',
                                \ 'FFFFFF', 'EAAAF0', 'CCDCFF', 'CCD8FF',
                                \ 'AAC1F0', 'CCD8FF', 'CCDCFF', '020A1B']
  endif
...
if &background == 'dark'
  ...
  hi Pmenu guibg=#425694 guifg=#FFFFFF gui=NONE cterm=NONE
  hi StatusLine guifg=#FFFFFF guibg=#425694 gui=NONE cterm=NONE
  hi StatusLineNC guifg=#FFFFFF guibg=#05215A gui=NONE cterm=NONE
  ...
  hi NeoTreeWinSeparator guifg=#05215A guibg=NONE gui=NONE cterm=NONE
  ...
  hi TabLine guifg=#FFFFFF guibg=#425694 gui=NONE cterm=NONE
  hi TabLineFill guifg=NONE guibg=NONE gui=NONE cterm=NONE
  hi TabLineSel guifg=#020A1B guibg=#CCDCFF gui=bold cterm=bold
  hi TabLineSeparator guifg=#6579A3 guibg=#425694 gui=NONE cterm=NONE

  " Interactive elements with dynamic contrast
  hi Search guifg=#05215A guibg=#AAC0F0 gui=NONE cterm=NONE
  hi Visual guifg=#05215A guibg=#9AB2E6 gui=NONE cterm=NONE
  hi MatchParen guifg=#05215A guibg=#CCDCFF gui=bold cterm=bold
  ...
  hi WhichKeyFloat guibg=#05215A guifg=NONE gui=NONE cterm=NONE

  " Selection and hover highlights with inverted colors
  hi CursorColumn guifg=NONE guibg=#425694 gui=NONE cterm=NONE
  hi Cursor guibg=#FFFFFF guifg=#020A1B gui=NONE cterm=NONE
  hi lCursor guibg=#FFFFFF guifg=#020A1B gui=NONE cterm=NONE
  hi CursorIM guibg=#FFFFFF guifg=#020A1B gui=NONE cterm=NONE
  hi TermCursor guibg=#FFFFFF guifg=#020A1B gui=NONE cterm=NONE
  hi TermCursorNC guibg=#FFFFFF guifg=#020A1B gui=NONE cterm=NONE
  ...
  hi QuickFixLine guifg=#05215A guibg=#9AB2E6 gui=NONE cterm=NONE
  hi IncSearch guifg=#05215A guibg=#CCDCFF gui=NONE cterm=NONE
  hi NormalNC guibg=#05215A guifg=#FFFFFF gui=NONE cterm=NONE
  hi Directory guifg=#AAC0F0 guibg=NONE gui=NONE cterm=NONE
  hi WildMenu guifg=#05215A guibg=#CCDCFF gui=bold cterm=bold

  " Add highlight groups for focused items with inverted colors
  hi CursorLineFold guifg=#CCDCFF guibg=#05215A gui=NONE cterm=NONE
  hi FoldColumn guifg=#FFFFFF guibg=NONE gui=NONE cterm=NONE
  hi Folded guifg=#FFFFFF guibg=#425694 gui=italic cterm=italic
  ...
  hi NeoTreeGitDeleted guifg=#9F65A3 guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeGitUntracked guifg=#7A8CC2 guibg=NONE gui=NONE cterm=NONE
  ...
  " hi NeoTreeCursorLine guibg=#9AB2E6 guifg=#020A1B gui=bold cterm=bold
  ...
  hi WinBar guifg=#FFFFFF guibg=#425694 gui=bold cterm=bold
  hi WinBarNC guifg=#FFFFFF guibg=#05215A gui=NONE cterm=NONE
  hi ExplorerSnack guibg=#CCDCFF guifg=#020A1B gui=bold cterm=bold
  hi BufferTabpageFill guibg=#020A1B guifg=#FFFFFF gui=NONE cterm=NONE
  ...
  hi BufferCurrentSign guifg=#CCDCFF guibg=#05215A gui=NONE cterm=NONE
  hi BufferVisible guifg=#FFFFFF guibg=#425694 gui=NONE cterm=NONE
  hi BufferVisibleMod guifg=#FFFFFF guibg=#425694 gui=NONE cterm=NONE
  hi BufferVisibleSign guifg=#9AB2E6 guibg=#05215A gui=NONE cterm=NONE
  hi BufferInactive guifg=#FFFFFF guibg=#05215A gui=NONE cterm=NONE
  hi BufferInactiveMod guifg=#6579A3 guibg=#05215A gui=NONE cterm=NONE
  hi BufferInactiveSign guifg=#6579A3 guibg=#05215A gui=NONE cterm=NONE
  ...
  hi Normal guibg=NONE guifg=#020A1B gui=NONE cterm=NONE
  hi Pmenu guibg=#FFFFFF guifg=#020A1B gui=NONE cterm=NONE
  hi StatusLine guifg=#FFFFFF guibg=#4B577D gui=NONE cterm=NONE
  hi StatusLineNC guifg=#020A1B guibg=#FFFFFF gui=NONE cterm=NONE
  hi VertSplit guifg=#4B577D guibg=NONE gui=NONE cterm=NONE
  hi LineNr guifg=#4B577D guibg=NONE gui=NONE cterm=NONE
  hi SignColumn guifg=NONE guibg=NONE gui=NONE cterm=NONE
  hi FoldColumn guifg=#05215A guibg=NONE gui=NONE cterm=NONE

  " NeoTree with transparent background including unfocused state
  hi NeoTreeNormal guibg=NONE guifg=#020A1B gui=NONE cterm=NONE
  hi NeoTreeEndOfBuffer guibg=NONE guifg=#020A1B gui=NONE cterm=NONE
  hi NeoTreeFloatNormal guibg=NONE guifg=#020A1B gui=NONE cterm=NONE
  ...
  " TabLine highlighting with complementary accents
  hi TabLine guifg=#020A1B guibg=#FFFFFF gui=NONE cterm=NONE
  hi TabLineFill guifg=NONE guibg=NONE gui=NONE cterm=NONE
  hi TabLineSel guifg=#FFFFFF guibg=#293652 gui=bold cterm=bold
  hi TabLineSeparator guifg=#4B577D guibg=#FFFFFF gui=NONE cterm=NONE

  " Interactive elements with complementary contrast
  hi Search guifg=#FFFFFF guibg=#3A4A6B gui=NONE cterm=NONE
  hi Visual guifg=#FFFFFF guibg=#4B577D gui=NONE cterm=NONE
  ...
  hi CmpItemMenu guifg=#05215A guibg=NONE gui=italic cterm=italic
  hi CmpItemAbbr guifg=#020A1B guibg=NONE gui=NONE cterm=NONE
  hi CmpItemAbbrDeprecated guifg=#425694 guibg=NONE gui=strikethrough cterm=strikethrough

  " Specific menu highlight groups
  hi WhichKey guifg=#293652 guibg=NONE gui=NONE cterm=NONE
  hi WhichKeySeparator guifg=#425694 guibg=NONE gui=NONE cterm=NONE
  ...
  hi Cursor guibg=#020A1B guifg=#FFFFFF gui=NONE cterm=NONE
  hi lCursor guibg=#FFFFFF guifg=#020A1B gui=NONE cterm=NONE
  hi CursorIM guibg=#FFFFFF guifg=#020A1B gui=NONE cterm=NONE
  hi TermCursor guibg=#020A1B guifg=#FFFFFF gui=NONE cterm=NONE
  hi TermCursorNC guibg=#FFFFFF guifg=#020A1B gui=NONE cterm=NONE
  hi CursorLine guibg=NONE ctermbg=NONE gui=underline cterm=underline
  ...
  hi NormalNC guibg=#FFFFFF guifg=#05215A gui=NONE cterm=NONE
  ...
  hi FoldColumn guifg=#05215A guibg=NONE gui=NONE cterm=NONE
  hi Folded guifg=#020A1B guibg=#FFFFFF gui=italic cterm=italic

  " File explorer specific highlights
  hi NeoTreeNormal guibg=NONE guifg=#020A1B gui=NONE cterm=NONE
  hi NeoTreeEndOfBuffer guibg=NONE guifg=#020A1B gui=NONE cterm=NONE
  hi NeoTreeRootName guifg=#293652 guibg=NONE gui=bold cterm=bold
  hi NeoTreeFileName guifg=#020A1B guibg=NONE gui=NONE cterm=NONE
  ...
  hi NeoTreeGitAdded guifg=#57658F guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeGitDeleted guifg=#9F65A3 guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeGitUntracked guifg=#7A8CC2 guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeIndentMarker guifg=#57698F guibg=NONE gui=NONE cterm=NONE
  ...
  hi WinBar guifg=#020A1B guibg=#FFFFFF gui=bold cterm=bold
  hi WinBarNC guifg=#05215A guibg=#FFFFFF gui=NONE cterm=NONE
  hi ExplorerSnack guibg=#293652 guifg=#FFFFFF gui=bold cterm=bold
  hi BufferTabpageFill guibg=#FFFFFF guifg=#425694 gui=NONE cterm=NONE
  ...
  hi BufferVisible guifg=#020A1B guibg=#FFFFFF gui=NONE cterm=NONE
  hi BufferVisibleMod guifg=#05215A guibg=#FFFFFF gui=NONE cterm=NONE
  hi BufferVisibleSign guifg=#4B5B7D guibg=#FFFFFF gui=NONE cterm=NONE
  hi BufferInactive guifg=#425694 guibg=#FFFFFF gui=NONE cterm=NONE
...
hi FloatBorder guifg=#4B577D guibg=NONE gui=NONE cterm=NONE
hi SignColumn guifg=NONE guibg=NONE gui=NONE cterm=NONE
hi DiffAdd guifg=#FFFFFF guibg=#7A91C2 gui=NONE cterm=NONE
hi DiffChange guifg=#FFFFFF guibg=#6574A3 gui=NONE cterm=NONE
hi DiffDelete guifg=#FFFFFF guibg=#9F65A3 gui=NONE cterm=NONE
hi TabLineFill guifg=NONE guibg=NONE gui=NONE cterm=NONE

" Fix selection highlighting with proper color derivatives
hi TelescopeSelection guibg=#CCD8FF guifg=#020A1B gui=bold cterm=bold
hi TelescopeSelectionCaret guifg=#FFFFFF guibg=#CCD8FF gui=bold cterm=bold
hi TelescopeMultiSelection guibg=#9AACE6 guifg=#020A1B gui=bold cterm=bold
hi TelescopeMatching guifg=#BC7AC2 guibg=NONE gui=bold cterm=bold

" Minimal fix for explorer selection highlighting
hi NeoTreeCursorLine guibg=#CCD8FF guifg=#020A1B gui=bold

" Fix for LazyVim menu selection highlighting
hi Visual guibg=#FBCCFF guifg=#020A1B gui=bold
hi CursorLine guibg=NONE ctermbg=NONE gui=underline cterm=underline
hi PmenuSel guibg=#FBCCFF guifg=#020A1B gui=bold
hi WildMenu guibg=#FBCCFF guifg=#020A1B gui=bold
...
augroup FixNeoTreeBackground
  ...
  autocmd ColorScheme,VimEnter * if &background == 'dark' |
    \ hi NeoTreeCursorLine guibg=#CCD8FF guifg=#020A1B gui=bold cterm=bold |
    \ hi NvimTreeCursorLine guibg=#CCD8FF guifg=#020A1B gui=bold cterm=bold |
    \ else |
